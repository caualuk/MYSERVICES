...
import { FaSortAmountDown, FaSortAmountUp, FaCalendarAlt, FaDollarSign, FaChevronDown } from "react-icons/fa";
...
export default function FilterDropdown({ onFilterChange, currentFilter }: FilterDropdownProps) {
  ...
  const filters = [
    { value: "recent", label: "Mais recentes", icon: <FaCalendarAlt className="text-indigo-600" /> },
    { value: "oldest", label: "Mais antigas", icon: <FaCalendarAlt className="text-indigo-600" /> },
    { value: "highest", label: "Maior valor", icon: <FaSortAmountUp className="text-indigo-600" /> },
    { value: "lowest", label: "Menor valor", icon: <FaSortAmountDown className="text-indigo-600" /> },
  ];
